...
//			inputReprint = achieveType.substring(0, achieveType.length() - 1);
			...
			if(!"--".equals(request.getParameter("sltYear")) && request.getParameter("sltYear") != null) {	//某个时间
			...
			else if(!"--".equals(request.getParameter("staYear")) && request.getParameter("staYear") != null) {	//时间段
