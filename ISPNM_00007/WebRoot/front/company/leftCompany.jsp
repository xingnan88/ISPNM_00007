...
<html>
	...
	-->
		...
		<!-- 
		<script type="text/javascript" src="<%=basePath%>front/company/js/indexCompany.js"></script>
		 -->
	</head>
	...
	<body>
		<div id="left" style="overflow: hidden;">
			...
			<div>
				...
				imageSrcArray[0]="<%=basePath%>front/company/images/newsCompany-1.jpg";
				imageIDsArray[0]="#";
				imageIntroArray[0]="国家安全监管总局督查我市冶金企业...";
				imageSrcArray[1]="<%=basePath%>front/company/images/newsCompany-2.jpg";
				imageIDsArray[1]="#";
				imageIntroArray[1]="邯邢矿冶设计院与加拿大某矿业公司...";
				imageSrcArray[2]="<%=basePath%>front/company/images/newsCompany-3.jpg";
				imageIDsArray[2]="#";
				imageIntroArray[2]="武进区召开重点冶金企业安全管理会议...";
				imageSrcArray[3]="<%=basePath%>front/company/images/newsCompany-4.jpg";
				imageIDsArray[3]="#";
				imageIntroArray[3]="云南蒙自矿冶公司铟萃取";
				imageSrcArray[4]="<%=basePath%>front/company/images/newsCompany-5.jpg";
				imageIDsArray[4]="#";
				imageIntroArray[4]="智利冶金工业企业协会一行来北京科技...";
