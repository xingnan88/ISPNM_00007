	...
	<body>
		<center>
			<table>
				...
				<tr>
					<td>
						<iframe marginwidth=0 marginheight=0 src="leftFeature.jsp" frameborder=no
							scrolling=no width=250 height=857></iframe>
					</td>
					<td>
						<iframe name="main" marginwidth=0 marginheight=0
							src="AchieveDetail!detailFore.action?achieveId=${param.achieveId }&achieveType=${param.achieveType }&achieveName=${param.achieveName }" frameborder=no scrolling=no width=766 height=857></iframe>
					</td>
				</tr>
				<tr>
					<td colspan="2">
