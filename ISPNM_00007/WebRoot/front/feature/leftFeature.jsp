	...
	<body>
		<div id="left" style="overflow: hidden;">
			...
			<div>
				...
				imageSrcArray[0]="<%=basePath%>front/feature/images/newsFeature-1.jpg";
				imageIDsArray[0]="#";
				imageIntroArray[0]="北京金属学会论文评选";
				imageSrcArray[1]="<%=basePath%>front/feature/images/newsFeature-2.jpg";
				imageIDsArray[1]="#";
				imageIntroArray[1]="中国钢铁产业";
				imageSrcArray[2]="<%=basePath%>front/feature/images/newsFeature-3.jpg";
				imageIDsArray[2]="#";
				imageIntroArray[2]="炼焦技术及焦炭市场国际大会";
				imageSrcArray[3]="<%=basePath%>front/feature/images/newsFeature-4.jpg";
				imageIDsArray[3]="#";
				imageIntroArray[3]="沛县“一区五园”";
				imageSrcArray[4]="<%=basePath%>front/feature/images/newsFeature-5.jpg";
				imageIDsArray[4]="#";
				imageIntroArray[4]="温州金属板材、管材、棒材...";
