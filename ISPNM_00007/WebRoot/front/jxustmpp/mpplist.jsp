...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>front/jxustmpp/jquery-ui/js/jquery-1.6.2.min.js">
</script>
		<script type="text/javascript"
			src="<%=basePath %>front/jxustmpp/jquery-ui/js/jquery-ui-1.8.15.custom.min.js">
</script>
		<script type="text/javascript" src="<%=basePath%>front/jxustmpp/index.js">
</script>
		<style type="text/css">
a.db {
	font-family: '楷体';
...
label {
	...
	<body >
	   <iframe marginwidth=0 marginheight=0  align="center" src="<%=basePath %>top.jsp" frameborder=no
							scrolling=no width=1020 height=145></iframe>
		<table id="main" style="">
			<tr>
				<td>
					<div style="height: 36px;"></div>
					<div id="left" style="height:940px;overflow: hidden;">
						<!-- 图片新闻区域 -->
						<div>
							<div
				...
				<td>
					<div id="content" style="background-color: white;">
						<div class="modeltitle">
							<span class="modeltag">当前位置：<a>&nbsp;首页&nbsp;</a>>&nbsp;矿冶生产流程库</span><span
								class="modelbody">矿冶生产流程库</span>
						</div>
						...
						<div id="recoms" style="width: 100%;">
							<div id="tabs">
								<ul style="padding-left: 0; margin-top: 0px;">
									<li class="now">
										<a href="javascript:;" name="recom-0">&nbsp;露天采矿&nbsp;</a>
									</li>
									<li>
										<a href="javascript:;" name="recom-1">&nbsp;井下之空场采矿&nbsp;</a>
									</li>
									<li>
										<a href="javascript:;" name="recom-2">&nbsp;井下之崩落采矿&nbsp;</a>
									</li>
									<li>
										<a href="javascript:;" name="recom-3">&nbsp;井下之充填采矿&nbsp;</a>
									</li>
								</ul>
							</div>

							<div id="recom-0" class="recom">
								<s:iterator value="lists">
									<s:if test="kcfs == '露天采矿'">
										<div class="recom_div">
											...
											<div class="post">
												<a href="front/jxustmpp/play.action?mpp.id=<s:property value="id"/>"
													title="<s:property value="ffname"/>"><img
														src="<%=basePath%><s:property value="tplj"/>"
														alt="<s:property value="ffname"/>"
														title="<s:property value="ffname"/>"
														class="post-thumbnail" />
												</a>
													文字说明：
													<s:if test="%{null!=wzsm&&wzsm.length()>50}">
														<s:property value="%{wzsm.substring(0, 50)}" />...
                                					</s:if>
													<s:else>
														<s:property value="wzsm" />
													</s:else>
													<br />
													...
													<br />
												<a href="front/jxustmpp/play.action?mpp.id=<s:property value="id"/>"
													title="<s:property value="ffname"/>" class="readmore">点击播放</a>
											</div>
										</div>
									</s:if>
								</s:iterator>
							...
							<div id="recom-1" class="recom" style='display: none'>
								<s:iterator value="lists">
										...
										<div class="recom_div">
											...
											<div class="post">
												<a href="front/jxustmpp/play.action?mpp.id=<s:property value="id"/>"
													...
													适用范围：
													<s:if test="%{null!=syfw&&syfw.length()>20}">
														<s:property value="%{syfw.substring(0, 20)}" />...
                                	  				</s:if>
													<s:else>
														<s:property value="syfw" />
													</s:else>
													<br />
													矿块参数：
													<s:if test="%{null!=kkcs&&kkcs.length()>7}">
														<s:property value="%{kkcs.substring(0, 7)}" />...
                                	  				</s:if>
													<s:else>
														<s:property value="kkcs" />
													</s:else>
													<br />
													采砌工作：
													<s:if test="%{null!=cqgz&&cqgz.length()>7}">
														<s:property value="%{cqgz.substring(0, 7)}" />...
                                	  </s:if>
													<s:else>
														<s:property value="cqgz" />
													</s:else>
													<br />
													回采工作：
													<s:if test="%{null!=hcgz&&hcgz.length()>7}">
														<s:property value="%{hcgz.substring(0, 7)}" />...
                                	  </s:if>
													<s:else>
														<s:property value="hcgz" />
													</s:else>
													<br />
													<s:date name="time" format="yyyy-MM-dd" />
													/
							...
							<div id="recom-2" class="recom" style='display: none'>
								<s:iterator value="lists">
							...
							<div id="recom-3" class="recom" style='display: none'>
								<s:iterator value="lists">
		...
		<iframe marginwidth=0 marginheight=0 align="center" src="<%=basePath %>bottom.jsp" frameborder=no
