   		...
   		<table id="listTable">
			...
			<tr>
				<td colspan="5" align="center">
					<s:if test="page > 1">
					<a href="<%=basePath%>front/equipment/search?page=${page-1 }&keyWord=${requestScope.keyWord }&method=${requestScope.method }" title="上一页 " id="prev">上一页</a>
					</s:if>
					第${page}页
					<s:if test="page*25 < count">
					<a href="<%=basePath%>front/equipment/search?page=${page+1 }&keyWord=${requestScope.keyWord }&method=${requestScope.method }" title="下一页" id="next">下一页</a>
					</s:if>
					<a href="#">跳至</a>
