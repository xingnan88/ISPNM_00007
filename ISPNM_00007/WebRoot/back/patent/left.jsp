			...
			<td width="182" valign="top">
				<div id="container">
					...
					<div class="content">
						...
						<ul class="MM">
							<li>
								<a href="back/patent/Patent_list?page=1" target="main">专利信息</a>
							</li>
							<li>
								<a href="back/patent/categoryList.jsp" target="main">专利分类</a>
							</li>
							<li>
								<a href="back/patent/Patent_addInput" target="main">专利添加</a>
							</li>
							<li>
								<a href="back/patent/Patent_searchInput" target="main">高级搜索</a>
							</li>
						</ul>
					</div>
				</div>
