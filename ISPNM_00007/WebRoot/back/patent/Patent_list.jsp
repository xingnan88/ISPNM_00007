...
<form id="del" name="del" action="back/patent/Patent_deleteSelect" method="post">
	<table border="1" cellpadding=0 cellspacing=0 bordercolor="#E8E8FF"
		...
		<s:iterator value="pageBean.list" var="p" status="status">
			...
			<td>
				<a href="<%=basePath%>back/patent/Patent_read?id=<s:property value="#p.id"/>"><font color="#DAA520">查看</font></a>
				<a href="<%=basePath%>back/patent/Patent_delete?id=<s:property value="#p.id"/>"><font color="#DAA520">删除</font></a>
				<a href="<%=basePath%>back/patent/Patent_updateInput?id=<s:property value="#p.id"/>"><font color="#DAA520">修改</font></a>
			</td>
			</tr>
		</s:iterator>
