...
-->
	...
	<script type="text/javascript">
		...
		<script type="text/javascript">
			...
			function simple_search() {
				window.location.href="SearchCompany!searchCompany.action?page=1";
			}
			function senior_search() {
				window.location.href="<%=basePath%>/back/company/SeniorSearchCompany.jsp?ran=1";
			}
	...
	<body>
		...
		<div id="mainContent" style="width:95%">
			<form name="seniorSearchForm" action="SearchCompany!searchCompany.action?page=1" onsubmit="return check_data()">
				<div id="searchDiv">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input class="button"
						style="background-image: url(<%=basePath %>back/company/images/yimgbt.gif);" type="submit"
						value="  搜 索" onclick="return simple_search();"/>
						&nbsp;
					<input type="submit" class="button" value="高级搜索"
						style="background-image: url(<%=basePath %>back/company/images/yimgbt.gif);"
						onclick="return senior_search();" />
				</div>
			</form>

			<form id="listForm" action="DeleteCompanyMore.action?page=1" onsubmit="valid_check()"
				method="post">
				<div id="listDiv" style="width: 100%;">
					<div class="headBorder">
						<span style="width: 150px;">企业编号</span>
						<span style="width: 200px;">企业名称</span>
					</div>
					...
					<s:if test="pageBean.list.size() != 0">
						<s:iterator id="company" value="pageBean.list" status="art">
							<div style="margin-buttom: 10px;">
								<div style="height: 25px;">
									...
									<span style="width: 450px"><a
										href="CompanyDetail!detail.action?id=<s:property value="#company.id"/>"><s:property
												value="#company.name" />
									...
									<a style="text-align:right;"
										href="UpdateCompany!searchone.action?id=<s:property value="#company.id"/>&ran=1">修改</a>
									</span>
									<span>
									<a style="text-align:right;"
										href="DeleteCompany.action?id=<s:property value="#company.id"/>&page=1"
