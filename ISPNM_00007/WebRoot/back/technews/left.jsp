		...
		<table width="100%" height="280" border="0" cellpadding="0"
			...
			<tr>
				<td width="182" valign="top">
					<div id="container">
						<h1 class="type">
							<a href="javascript:void(0)">矿冶科技动态信息管理</a>
						</h1>
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="back/technews/TechNews_list?page=1" target="main">信息管理</a>
								</li>
								<li>
									<a href="back/technews/TechNews_addInput" target="main">信息添加</a>
								</li>
								<li>
									<a href="back/technews/TechNews_searchInput" target="main">高级搜索</a>
								</li>
							</ul>
						</div>
