		...
		<div id="mainContent" style="width:95%">
			...
			<div style="margin: 0px; width: 100%">
				<a
					...
					onclick="return delete_confirm()" class="opera">删除信息</a>
				<a
					href="BeforeUpdateAchieve?achieveId=<s:property value="achieve.achieveId" />&achieveType=<s:property value="achieve.achieveType" />"
					class="opera">修改信息</a>
			...
			<div>
				<table style="width: 100%;" id="baseInfo" cellpadding="0"
					...
					<tr>
						...
						<td>
							<s:property value="achieve.awardName" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<s:property value="achieve.awardGrade" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<s:if test="achieve.achieveType=='001001'">
								科研成果
							</s:if>
							<s:if test="achieve.achieveType=='001002'">
								教学成果
							</s:if>
							<s:if test="achieve.achieveType=='001000'">
								暂无获奖类别
							</s:if>
						</td>
					</tr>
