...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function check_data() {
				...
				else if(addAchieveForm.projectSource.value.length==0){
	...
	<body>
		...
		<div id="mainContent" style="width:95%">
			<s:form name="addAchieveForm" onsubmit="return check_data()" action="AddAchieve!addAchieve.action?page=1" theme="simple" method="post">
				<div id="title"
				...
				<table style="width: 100%;" id="baseInfo" cellpadding="0"
					...
					<tr>
						...
						<td>
							<s:select
								list="#{'002000':'请选择科研类别','002001':'国际项目','002002':'国家项目','002003':'省级项目','002004':'市级项目','002005':'横向项目'}"
