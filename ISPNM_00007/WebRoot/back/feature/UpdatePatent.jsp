	...
	<head>
		...
		<script type="text/javascript">
			...
			function check_data() {
				...
				else if(updateAchieveForm.patentClass.value.length==0){
			  		alert("输入的专利类别为空，请重新输入！");
			  		return false;
				}
				else if(updateAchieveForm.approvalUnit.value.length==0){
			  		alert("输入的批准单位为空，请重新输入！");
			  		return false;
				}
				else if(updateAchieveForm.certNo.value.length==0){
			...
			<s:form name="updateAchieveForm" onsubmit="return check_data()" action="UpdateAchieve.action?page=1"
				...
				<table style="width: 100%;" id="baseInfo" cellpadding="0"
					...
					<tr>
						...
						<td>
							<s:textfield name="patentClass" value="%{achieve.patentClass}" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<s:textfield name="approvalUnit" value="%{achieve.approvalUnit}" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<s:textfield name="certNo" value="%{achieve.certNo}" />
						</td>
					</tr>
					<tr>
						<td align="right">
