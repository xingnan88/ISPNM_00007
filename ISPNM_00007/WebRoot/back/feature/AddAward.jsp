...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function check_data() {
				...
				else if(addAchieveForm.achieveSubject.value.length==0){
	...
	<body>
		...
		<div id="mainContent" style="width:95%">
			<s:form name="addAchieveForm" onsubmit="return check_data()"
				action="AddAchieve!addAchieve.action?page=1" theme="simple" method="post">
				<div id="title"
				...
				<table style="width: 100%;" id="baseInfo" cellpadding="0"
					...
					<tr>
						...
						<td>
							<s:select list="#{'001000':'请选择获奖类别','001001':'科研成果','001002':'教学成果'}" listKey="key"
								listValue="value" name="achieveType">
							</s:select>
						</td>
					</tr>
					<tr>
