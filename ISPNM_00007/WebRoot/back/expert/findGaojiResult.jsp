...
function piliang() {
	...
	<body bgcolor="#ffffc0">
		<form action="" method="post" name="myform" id="myform">
			<table id="theObjTable" style="table-layout: fixed;font-size: 14px;background-color: #c0c0c0" border="0"
				cellpadding="0px">
					...
					<tr style="border: 0px">
						...
						<td valign="top" height="32">
							<div class="resizeDivClass"
								...
								onmousemove="MouseMoveToResize(this);"
								onmouseup="MouseUpToResize(this);"></div>
							<s:property value="#expert.workplace" escape="false"/>
						</td>
						<td valign="top" height="32">
							<div class="resizeDivClass"
								onmousedown="MouseDownToResize(this);"
								onmousemove="MouseMoveToResize(this);"
								onmouseup="MouseUpToResize(this);"></div>
							<s:property value="#expert.workposition" escape="false"/>
						</td>
			...
			<table align="center"
				...
				<tr>
					...
					<td>
						<a href="<%=basePath%>back/expert/expert_findGaoji.action?page=1&researchFields=${researchFields}&name=${name}&majorFields=${majorFields}&workplace=${workplace}&researchCon=${researchCon}&workposition=${workposition}">首页</a>
					</td>
					<td>
						<a
							href="<%=basePath%>back/expert/expert_findGaoji.action?page=<%=(Integer) request.getAttribute("page") - 1%>&researchFields=${researchFields}&name=${name}&majorFields=${majorFields}&workplace=${workplace}&researchCon=${researchCon}&workposition=${workposition}">上一页</a>
					</td>
					<td>
						<a
							href="<%=basePath%>back/expert/expert_findGaoji.action?page=<%=(Integer) request.getAttribute("page") + 1%>&researchFields=${researchFields}&name=${name}&majorFields=${majorFields}&workplace=${workplace}&researchCon=${researchCon}&workposition=${workposition}">下一页</a>
					</td>
					<td>
						<a
							href="<%=basePath%>back/expert/expert_findGaoji.action?page=<s:property value="pageCount"/>&researchFields=${researchFields}&name=${name}&majorFields=${majorFields}&workplace=${workplace}&researchCon=${researchCon}&workposition=${workposition}">尾页</a>
					</td>
					<td>
						转到
...
function goCurrentPage() {
	...
	location.href = "<%=basePath%>back/expert/expert_findGaoji.action?page="+ page+"&researchFields=${researchFields}&name=${name}&majorFields=${majorFields}&workplace=${workplace}&researchCon=${researchCon}&workposition=${workposition}";
}
</script>
