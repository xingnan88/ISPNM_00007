			...
			<div align="center">
				<table width="100%" border="0">
					...
					<tr>
						...
						<td colspan="4">
							<textarea name="majorFields" id="majorFields" cols="4" rows="4"
								style="width: 50% ;vertical-align: top; text-align: left"><s:property value="expert.majorFields"/></textarea>
					...
					<tr>
						...
						<td colspan="4">
							<textarea rows="4" cols="4" name="researchCon" id="researchCon"  style="width: 50%;text-align: left; vertical-align: text-top"><s:property value="expert.researchCon" /></textarea>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="phone" id="phone"
								value="<s:property value="expert.phone"/>" />
						</td>
					</tr>
					<tr>
						<td height="24" align="center">
