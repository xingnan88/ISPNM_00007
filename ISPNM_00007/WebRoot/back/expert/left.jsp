			...
			<tr>
				<td width="182" valign="top">
					<div id="container">
						...
						<h1 class="type">
							<a href="javascript:void(0)">专家库管理</a>
						</h1>
						<div class="content">
							...
							<ul class="MM">
								...
								<li>
									<a href="<%=basePath%>back/expert/findGaoji.jsp" target="main">高级查找</a>
								</li>
									<li>
									<a href="<%=basePath%>back/expert/expert_testSave.action" target="main">批量插入专家</a>
								</li>
							</ul>
						</div>
						<h1 class="type">
